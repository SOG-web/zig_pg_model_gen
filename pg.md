...
When using the pool, a new connection/session is created. It _does not_ use a connection from the pool. This is merely a convenience function if you're also using normal connections through a pool.
